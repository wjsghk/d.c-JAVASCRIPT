...
function Cat(name) {
  this.name = name;//여기서 this는 누군지 아직모른상태 새 생성자르 대입시 그 생성자가 this
...
const cat = new Cat('냐옹');//위 this 가리키는 Cat이된다.
const dog = new Dog('멍멍');//위 this 가리키는 Dog이된다.
...
function printOnMonitor(printName) {
  ...
  printName();//고양이의 이름을 출력한다옹: undefined
}
